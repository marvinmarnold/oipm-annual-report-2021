		...
		body={
			<div>
				...
				<Row className="text-center">
					<Col className="py-5">
					<a href="/force-officer" className="text-white"><Button size="lg" color="secondary" className="mx-3">&lt; Previous: Force by officer details</Button></a>
					<a href="/force-future" className="text-white"><Button size="lg" color="success">Next: Future analysis ></Button></a>
